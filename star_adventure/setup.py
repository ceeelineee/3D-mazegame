...
MAP = [
    ...
    [1, _, 3, _, _, 6, 7, _, 9, 10, _, 12, _, _, 15, _, 16, _, _, 20],
    [1, _, _, _, 5, 6, 7, _, 9, _, _, 12, _, 15, 15, _, 16, 17, _, 20],
    ...
    [1, _, 3, 4, 'c', 6, 7, _, 9, _, 11, _, 13, _, 15, _, 17, _, 19, 20],
    [1, 'c', _, 4, _, 6, _, _, _, _, 11, _, 13, _, _, _, 17, _, 19, 20],
    [1, _, 3, 4, _, 6, _, 8, 9, _, 11, _, 13, _, 15, _, 17, _, 19, 20],
    [1, 'p', _, 4, _, _, 'c', _, _, _, 11, _, 13, _, 15, _, 17, _, 19, 20],
